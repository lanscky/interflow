...
from .views import (
    ...
    CandidatureViewSet, AffectationStageViewSet, EvaluationViewSet,
    FormationViewSet, CompetenceViewSet,SubscriptionViewSet,CompanySubscriptionViewSet,PaymentViewSet,ConfigViewSet
)
