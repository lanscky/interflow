...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://redis:6379/0",  # tu peux mettre /0 ou /1 selon ton organisation
        "OPTIONS": {
...
#MEDIA_URL = '/media/'
#MEDIA_URL = 'https://d8mo62pg9935d.cloudfront.net/'
...
# settings.py - CONFIGURATION MODERNE Django 5.x
STORAGES = {
    "default": {
    ...
    "staticfiles": {
        ...
        # Ou pour staticfiles dans S3 aussi :
        # "BACKEND": "storages.backends.s3.S3Storage",
        # "OPTIONS": { ... }
    },
}
...
# URLs (optionnel)
AWS_S3_CUSTOM_DOMAIN = 'd8mo62pg9935d.cloudfront.net'
